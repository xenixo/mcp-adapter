...
LDFLAGS := -s -w \
	-X 'github.com/xenixo/mcp-adapter/internal/cli.Version=$(VERSION)' \
	-X 'github.com/xenixo/mcp-adapter/internal/cli.Commit=$(COMMIT)' \
	-X 'github.com/xenixo/mcp-adapter/internal/cli.BuildDate=$(BUILD_DATE)'
